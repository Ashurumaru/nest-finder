    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day: 'p-0 size-8 text-sm flex-1 flex items-center justify-center',
                day_button: cn(
                ...
                today: 'bg-gray-200 text-accent-foreground',
                outside:
                    'day-outside text-muted-foreground opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30',
                disabled: 'text-muted-foreground opacity-50',
                range_middle:
                    'aria-selected:bg-blue-300 aria-selected:text-accent-foreground rounded-none aria-selected:text-accent-foreground hover:aria-selected:text-accent-foreground',
                hidden: 'invisible',
                ...classNames,
            }}
            components={{
